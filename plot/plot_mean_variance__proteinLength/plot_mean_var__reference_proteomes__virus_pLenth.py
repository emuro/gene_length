...
df_prot_stat_desc = df_prot_stat_desc[df_prot_stat_desc.superregnum=="viruses"]
if 0:
    pd.options.display.max_columns=None
    print(df_prot_stat_desc.head(9))
    sys.exit()

#print(df_prot_stat_desc["species"].tolist())

#df_prot_stat_desc = df_prot_stat_desc[df_prot_stat_desc["species"].str.contains('phage|Phage', na=False)]
df_prot_stat_desc = df_prot_stat_desc[df_prot_stat_desc["species"].str.contains('coronavirus', na=False)]

print(df_prot_stat_desc["species"].tolist())
print(len(df_prot_stat_desc["species"].tolist()))

#sys.exit()

df2plot = df_prot_stat_desc.copy()
df2plot = df2plot[["species", "superregnum", "count", "mean", "var"]]
