...
- [meanOfLn_lnOfMean.ipynb](https://github.com/emuro/gene_length/blob/main/main_work/suppl_work/meanOfLn_lnOfMean.ipynb): for the gene length's distributions of the different genomes. Here we compare the mean of the log of the lengths, $\langle log L \rangle$ , and the log of the mean of lengths, $log \langle L \rangle$. It corresponds to the Extended Data Fig. 5.  
